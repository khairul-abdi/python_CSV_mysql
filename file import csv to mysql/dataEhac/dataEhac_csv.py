      ...
      for row in csv_reader:
        if status != 0:
          ...
          if row[3][2] == "/":
            ...
            row[3] = str(dataSplit[2])+"/"+str(dataSplit[1])+"/"+str(dataSplit[0])

          if row[7][2] == "/":
            dataSplit = row[7].split("/")
            row[7] = str(dataSplit[2])+"/"+str(dataSplit[1])+"/"+str(dataSplit[0])
          
          if row[11][2] == "/":
            dataSplit = row[11].split("/")
            row[11] = str(dataSplit[2])+"/"+str(dataSplit[1])+"/"+str(dataSplit[0])
